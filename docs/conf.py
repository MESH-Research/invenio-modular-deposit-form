...
html_theme_options = {
    ...
    "github_repo": "invenio-modular-deposit-form",
    "github_button": False,
    "github_banner": True,
    "show_powered_by": False,
    "extra_nav_links": {
        "invenio-modular-deposit-form@GitHub": (
            "https://github.com/MESH-Research/invenio-modular-deposit-form"
        ),
        "invenio-modular-deposit-form@PyPI": (
            "https://pypi.python.org/pypi/invenio-modular-deposit-form/"
        ),
    },
}
...
htmlhelp_basename = "invenio-modular-deposit-form_namedoc"
...
latex_documents = [
    (
        master_doc,
        "invenio-modular-deposit-form.tex",
