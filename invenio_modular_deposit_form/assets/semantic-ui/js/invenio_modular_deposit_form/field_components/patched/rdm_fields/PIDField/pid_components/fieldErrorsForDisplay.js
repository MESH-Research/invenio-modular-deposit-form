...
// `field_components/patched/input_controls/TextField.js`, which only shows validation
// errors after touch (or for initial-server errors while the value is still the initial
// value).
//
...
// visibility logic as that `TextField` (touched + error, or initialError + unchanged value,
 ...
 *
 * Matches the visibility policy in `field_components/patched/input_controls/TextField.js`: show validation
