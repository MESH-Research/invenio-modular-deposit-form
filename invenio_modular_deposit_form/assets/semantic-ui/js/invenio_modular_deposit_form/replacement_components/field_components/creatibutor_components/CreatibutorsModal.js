...
//
// KCWorks fork: optional `onModalClose` runs whenever `closeModal()` is invoked
// (cancel, dimmer/X close, save-and-close, save-and-continue cycle) so the parent
// deposit field can mark the array field touched + revalidate.
